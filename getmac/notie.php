...
<body>
Online Network Card Mac Address Register for NSYSU College of Management<br />
中山大學管理學院網路使用客戶端註冊程式<br /><br /><br />

RIGHT CLICK and SAVE AS <a href="ip.vbs">this</a>. Open it to register your MAC address.<br />
請將 <a href="ip.vbs">註冊程式</a> 點選右鍵另存新檔後，開啟該程式以便完成註冊。<br />
<br />

若是你處於無法使用IE的情況，請使用下面的表格直接填寫申請資料。<br />
...
Step1.開始 -> 執行在開啟的欄位填入 cmd，若是使用vista或是win7系統，請在"搜尋程式及檔案"欄位輸入cmd
<br /><br />
Step2.出現命令提示字元的視窗
<br /><br />
Step3.在提示字元下填入 ipconfig /all，此命令會列出所有的網路卡，請找出你會對外連線的網路卡，該網路卡的Physical Address 就是您的網路卡卡號(MAC Address)
<br /><br />
</body>
</html>
