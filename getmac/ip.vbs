...
MsgBox("Please click OK and fill the form to upload your MAC address. If you get some problem, please retry it. Contact us:cccm@cm.nsysu.edu.tw Campus extension：4510  資料收集完成,請按任一鍵此程式會呼叫IE,並將你的本機mac資訊上傳到網管系統.如果有問題或填寫錯誤請再重新執行一次即可!!聯絡Email:cccm@cm.nsysu.edu.tw 校內分機：4510")
